...
========================================
사용된 플레이스홀더(Placeholder) 변경
========================================

기본적으로 ``(:segment)`` 플레이스홀더는 리소스 ID가 필요할 때 사용됩니다.
...
기본적으로 ``(:segment)`` 플레이스홀더는 리소스 ID가 필요할 때 사용됩니다. 사용할 새 문자열과 함께 ``placeholder`` 옵션을 전달하면 이 항목을 변경할 수 있습니다.
