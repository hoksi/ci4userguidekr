...
.. important:: 'Helloworld.php'는 대문자 'H'로 시작되어야 합니다. 컨트롤러 클래스 이름은 대문자로 시작해야 하며 첫 번째 문자만 대문자일 수 있습니다.
...
.. 중요:: Auto Routing(기존)은 **모든** HTTP 메서드를 사용하여 HTTP 요청을 컨트롤러 메서드로 라우팅합니다.
...
.. 참고:: 컨트롤러의 짧은 이름이 URI의 첫 번째 세그먼트와 일치하면 로드됩니다.
...
.. important:: 파일 이름은 **Helloworld.php**\ 여야 하며 대문자는 ``H``여야 합니다. 컨트롤러 클래스 이름은 대문자로 시작해야 하며 첫 번째 문자만 대문자일 수 있습니다.
